            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-primary">USER.{program.userId}</span>
                </div>
              ...
              <CardHeader className="pt-6 px-5">
                <div className="flex items-center gap-4 mb-4">
                  <div className="h-16 w-16 rounded-full overflow-hidden border border-border bg-primary/5 flex items-center justify-center">
                ...
                <div className="flex justify-between items-center gap-4">
                  <div className="px-3 py-1 bg-primary/10 rounded-full border border-primary/20 text-sm text-primary flex items-center gap-2">
                ...
                <div className="mt-5 pt-5 border-t border-border">
                  <div className="flex gap-2 flex-wrap">
                    {program.roadmapPlan.constraints.map((constraint, index) => (
                      <span
                        key={index}
                        className="px-2 py-1 bg-background rounded-md text-xs text-muted-foreground border border-border"
                      >
                        {constraint}
                      </span>
                    ))}
